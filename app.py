...
def run_ml_app():
    ...
    education = right.selectbox("Education", ("Graduate", "No"))
    ...
    loan_amount_term = left.number_input(label = "Loan Amount Term", min_value = 360)
...
def predict(gender, married, dependent, education, self_employed, applicant_income, coApplicant_income
    ...
    prop = 0 if property_area == "Semiurban" else 1 if property_area == "Urban" else 2
